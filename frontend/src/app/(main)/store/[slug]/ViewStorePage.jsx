              ...
              >
                <div className="grid grid-cols-2 gap-2 md:gap-6 justify-items-center">
                  <button
                    ...
                    className="border-2 border-emerald-300 w-full flex items-center justify-center py-3 rounded-lg font-medium"
                  >
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      width={24}
                  ...
                  <button className="w-full bg-emerald-500  text-white flex items-center justify-center py-3 rounded-lg font-medium">
                    Buy Now
                  </button>
                </div>
              </div>
                ...
                <div className="px-3">
                    ...
                    <div className="hidden md:block w-full max-w-2xl mx-auto  border-2  border-gray-200 rounded-lg">
                      <div className="flex  border-b bg-gray-100">
                        {[
                          ...
                          { id: "help", label: "How will this book help you?" },
                        ].map((tab) => (
                          <button
                            key={tab.id}
                  ...
                  <div className="w-full grid grid-cols-3 md:flex justify-between items-center px-0 py-3.5 mt-8 md:px-4">
                    <div className="flex flex-col items-center gap-2.5 pr-3">
                      <img src="/security.svg" loading="lazy" alt="security" />
                    ...
                    <div className="flex flex-col items-center gap-2.5 pl-3">
                      <img src="/delivery.svg" loading="lazy" alt="delivery" />
                      <span className="text-[10px] md:text-[14px] font-semibold text-center text-greyish-black">
                        Trusted Shipping
                      </span>
                    </div>
