                      ...
                      <div className="flex items-center">
                        <a
                          className="
                                ...
                                "
                          href="/products/lakshya-neet-class-12-pcb-combo-2025"
                        >
                          <img
                            src="https://d2bps9p1kiy4ka.cloudfront.net/5eb393ee95fab7468a79d189/0b863a9b-e783-4eda-8549-539ca43eb937.png"
                            alt=""
                            ...
                            <div className="line-clamp-2">
                              <span className="Typography_heading6__f9EKE font-semibold Typography_root__TxCor">
                                <span className="text-black">
                                  Lakshya For NEET Class 12 Physics, Chemistry,
                                  Botany and Zoology Modules with Solutions
                                  &amp; 14 OMR Sheets Combo Set of 14 Books For
                                  (2025 Edition)
                                </span>
                              </span>
                            </div>
