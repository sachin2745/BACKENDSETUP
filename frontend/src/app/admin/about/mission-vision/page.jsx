...
const missionVision = () => {
  ...
  const formik = useFormik({
    ...
    validationSchema: Yup.object({
      ...
      ourMissionContent1: Yup.string().required("Required").max(46, "Must be 46 characters or less"),
      ourMissionImgAlt2: Yup.string().required("Required"),
      ourMissionContent2: Yup.string().required("Required").max(46, "Must be 46 characters or less"),
      ourMissionImgAlt3: Yup.string().required("Required"),
      ourMissionContent3: Yup.string().required("Required").max(46, "Must be 46 characters or less"),
